...
MINE_PATH = r"c:\Program Files\Microsoft Games\Minesweeper\MineSweeper.exe"
WIN_TITLE = "扫雷"
MINE_COUNT = 99
...
def get_client_rect():
    import win32gui    
    handle = auto.control_get_handle(WIN_TITLE, "Static1")
