...
class MenuDemo(HasTraits):
    ...
    def traits_view(self):
        file_menu = Menu( 
            ActionGroup(
                Action(id="open", name="打开", action="open_file"),
                Action(id="save", name="保存", action="save_file"),
            ),
            ActionGroup(
                Action(id="exit_app", name="退出", action="exit_app"),
            ),
            name = "文件"
        )
        
        about_menu = Menu(
            Action(id="about", name="关于", action="about_dialog"),
            name = "帮助"
        )
