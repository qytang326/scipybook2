...
import hdr_parser, sys, re, os, io
...
class ClassInfo(object):
    ...
    def gen_code(self, all_classes):
        ...
        getset_code = io.StringIO()
        getset_inits = io.StringIO()
        ...
        methods_code = io.StringIO()
        methods_inits = io.StringIO()
...
class PythonWrapperGenerator(object):
    ...
    def clear(self):
        ...
        self.funcs = {}
        self.consts = {}
        self.code_types = io.StringIO()
        self.code_funcs = io.StringIO()
        self.code_func_tab = io.StringIO()
        self.code_type_reg = io.StringIO()
        self.code_const_reg = io.StringIO()
        self.class_idx = 0
