...
class HoughDemo(ImageProcessDemo):
    ...
    def control_panel(self):
        return VGroup(
            Group(
                Item("blur_sigma", label="标准方差"),
                Item("show_blur", label="显示结果"),
                label="高斯模糊参数"
            ),
            Group(
                Item("th2", label="阈值2"),
            ...
            Group(
                Item("dp", label="分辨率(像素)"),
                Item("mindist", label="圆心最小距离(像素)"),
                Item("param2", label="圆心检查阈值"),
                Item("min_radius", label="最小半径"),
                Item("max_radius", label="最大半径"),
                label="圆检测"
            ),
            Group(
                Item("linewidth", label="线宽"),
                Item("alpha", label="alpha"),
                HGroup(
                    Item("check_line", label="直线"),
                    Item("check_circle", label="圆"),
                ),
                label="绘图参数"
            )
        )
