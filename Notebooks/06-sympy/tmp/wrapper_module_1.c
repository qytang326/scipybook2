...
static PyObject *__pyx_pf_16wrapper_module_1_autofunc_c(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_a, double __pyx_v_b, double __pyx_v_c); /* proto */
...
static PyObject *__pyx_pw_16wrapper_module_1_1autofunc_c(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_r = __pyx_pf_16wrapper_module_1_autofunc_c(__pyx_self, __pyx_v_a, __pyx_v_b, __pyx_v_c);
...
static PyObject *__pyx_pf_16wrapper_module_1_autofunc_c(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_a, double __pyx_v_b, double __pyx_v_c) {
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "wrapper_module_1")) {
      if (unlikely(PyDict_SetItemString(modules, "wrapper_module_1", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     cdef np.ndarray[np.double_t, ndim=2] out_1451769269 = np.empty((2,1))
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_16wrapper_module_1_1autofunc_c, NULL, __pyx_n_s_wrapper_module_1); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
